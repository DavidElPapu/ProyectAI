...
| Condición: El jugador esta cerca? |  (si) >  ---|
------------------------------------.                    
          (no) v                | |
______________________________  | |----------------------------------|
| Estado: Esperar al jugador |--|                                    |
-----------------------------.                                       |
              |          |-------------------------------------|     |
____________________________________________________           |     |
| Condición: Paso x segundos sin el jugador cerca? | (no) > ---|     |
---------------------------------------------------.                 |
                (si) v                                               |
          ______________________                                     |
          |  Estado: Ir a casa |-------------------------------------|
          ---------------------.
<img width="654" height="530" alt="image" src="https://github.com/user-attachments/assets/53efa493-8e74-4487-b20c-e29df0748c28" />
